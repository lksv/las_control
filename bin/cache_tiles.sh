...
curl "${BASE_URL}/local_administration_units" > /dev/null
curl "${BASE_URL}/local_administration_units/options.json?query=Brno&per=20&page=1&_=1458290270986" > /dev/null
