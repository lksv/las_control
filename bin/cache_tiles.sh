...
ruby bin/load_all_tiles.rb 'http://localhost:3000/tiles/%<zoom>s/%<x>s/%<y>s.json' '16.514168,49.289642,16.559486,49.320646' '15,16,17,18' # Kuřim
ruby bin/load_all_tiles.rb 'http://localhost:3000/tiles/%<zoom>s/%<x>s/%<y>s.json' '16.4007,49.331107,16.446018,49.362085' '15,16,17,18' # Tišnov
